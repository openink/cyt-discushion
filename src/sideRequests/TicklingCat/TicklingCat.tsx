...
import styles from "./TicklingCat.module.css";
...
export default function TicklingCat(){
    const onTickle = ()=>{
        if(randomInt(1, 2) == 1) new Audio(meow1).play();
        else new Audio(meow2).play();
    };
    return(
        <div className={styles.content}>
            <div className={styles.container}>
                <svg className={styles.bongocat} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 787.3 433.8">
                    <defs>
                        <symbol id="dc-siderequest-ticklingcat-eye" className={styles.eye} data-name="eye" viewBox="0 0 19.2 18.7">
                        ...
                        <symbol id="dc-siderequest-ticklingcat-paw-pads" className={styles.pawpads} data-name="paw-pads" viewBox="0 0 31.4 33.9">
                    ...
                    <g className={styles.head} onClick={onTickle} role="button">
                        <g className={styles.head__outline}>
                            <path d="M303.2,186.3c4-7,14.8-20.2,20-26,17-19,34.6-34.9,43-41l12-8s16.6-32,21-33c9-2,33,22,33,22s20-9,79,7c41,11.1,47,14,57,22,7.5,6,18,16,18,16s33.7-19.5,41-15-2,66-2,66,5.9,12.9,11,22c9.1,16.2,13.6,20.2,19,31,3.6,7.2,8.4,28.5,10.5,43.5l-385-62Z" fill="#ffffff30"></path>
                        ...
                        <g className={styles.head__face}>
                            <g className={styles.eyes}>
                                <use width="19.2" height="18.7" transform="translate(474.8 195.2)" xlinkHref="#dc-siderequest-ticklingcat-eye"></use>
                                <use width="19.2" height="18.7" transform="matrix(-0.51, -0.85, 0.82, -0.5, 370.39, 192.59)" xlinkHref="#dc-siderequest-ticklingcat-eye"></use>
                            </g>
                            <g className={styles.mouth}>
                                <path d="M399.2,186.3c.9,3.6,2.6,7.8,6,9,6.4,2.3,19-6,19-6s4.1,12.4,10,15,10.7-1.7,16-6" fill="#ffffff30"></path>
                    ...
                    <g className={styles.table}>
                        <path d="M65.7,181.8l714,124c0,74-2,54-2,128l-673-161Z" fill="#ffffff30"></path>
                    ...
                    <g className={styles.laptop}>
                        <g className={styles.laptop__base}>
                            <polygon points="641.9 304.1 454.7 348.2 103.8 271.3 254.6 230.3 641.9 304.1" fill="#f2f2f290"></polygon>
                        ...
                        <g className={styles.laptop__keyboard}>
                            <polygon points="371.1 274.8 256.8 253.5 257 252.7 266.2 251.1 382.4 271.5 382.3 272.3 371.1 274.8" fill="#3e3e5490"></polygon>
                            <polygon points="237.4 265.6 221.3 262.4 221.4 261.7 230.2 260.2 246.8 262.6 246.6 263.4 237.4 265.6" fill="#3e3e5490"></polygon>
                            <polygon points="474.6 312.9 249.9 268.1 250.1 267.3 259.2 265.8 487.7 309.6 487.5 310.5 474.6 312.9" fill="#3e3e5490"></polygon>
                            <polygon points="411.8 309.4 204.2 266.7 204.4 266 212.9 264.5 423.9 306.3 423.7 307.2 411.8 309.4" fill="#3e3e5490"></polygon>
                            <polygon points="450 317.3 428.5 312.9 428.8 312 440.7 310.6 462.7 314.1 462.5 315 450 317.3" fill="#3e3e5490"></polygon>
strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"></polygon>
                            </g>
                        </g>
                        <g className={styles.pawright}>
                            <g className={styles.pawrightdown}>
                                <path d="M293.2,191.3l10-7s-18.4,11.1-24,20-13,20.4-9,31c4.7,12.4,20.5,15.7,22,16,20,3.8,47.8-24.3,47.8-24.3s1.9-3.3,2.2-3.7" fill="#ffffff30"></path>
                            ...
                            <g className={styles.pawrightup}>
                                <g>
                                    <path d="M282.2,215.2c-1.6-1.6-12.8-17.9-14-34.3-.1-2.5,1.7-16,12.9-22.4s22.3-1.9,26.2.4c12.2,7.3,21.2,19.1,22.8,22.4" fill="#ffffff30"></path>
                                ...
                                <use width="31.4" height="33.93" transform="translate(273.2 166.1) rotate(-5.6)" xlinkHref="#dc-siderequest-ticklingcat-paw-pads"></use>
                            </g>
                        </g>
                        <g className={styles.laptop__terminal}>
                        ...
                        <g className={styles.laptop__terminal_code_scene}>
                            <g className={styles.laptop__code}>
                                <g stroke="#3DE0E8b0" strokeWidth="6" transform="matrix(-1 0 0 1 278 103)">
                                    <g className={styles.f3} transform="translate(0 76)">
                                        <path className={`${styles.typinganimation} ${styles.f3l9}`} d="M8,25L8,25" strokeDasharray="60,10"></path>
                                        <path className={`${styles.typinganimation} ${styles.f3l8}`} d="M8,13L8,13" strokeDasharray="50,10"></path>
                                        <path className={`${styles.typinganimation} ${styles.f3l7}`} d="M0,1L0,1" strokeDasharray="25,10"></path>
                                    </g>
                                    <g className={styles.f2} transform="translate(0 38)">
                                        <path className={`${styles.typinganimation} ${styles.f2l6}`} d="M8,25L8,25" strokeDasharray="40,10"></path>
                                        <path className={`${styles.typinganimation} ${styles.f2l5}`} d="M8,13L8,13" strokeDasharray="60,10"></path>
                                        <path className={`${styles.typinganimation} ${styles.f2l4}`} d="M0,1L0,1" strokeDasharray="30,10"></path>
                                    </g>
                                    <g className={styles.f1}>
                                        <path className={`${styles.typinganimation} ${styles.f1l3}`} d="M8,25L8,25" strokeDasharray="60,10"></path>
                                        <path className={`${styles.typinganimation} ${styles.f1l2}`} d="M8,13L8,13" strokeDasharray="60,10"></path>
                                        <path className={`${styles.typinganimation} ${styles.f1l1}`} d="M0,1L0,1" strokeDasharray="60,10"></path>
                                    </g>
                                </g>
                            </g>
                        </g>
                        <g className={styles.laptop__cover} style={{ mixBlendMode: "hard-light" }}>
                            <polygon points="440.7 347.2 90.3 275.6 4.7 3.8 353 36.7 440.7 347.2" fill="#f2f2f290"></polygon>
                    ...
                    <g className={styles.pawleft}>
                        <g className={styles.pawleftup}>
                            <g>
                                <path d="M545.4,261.9c-7.1-13-12.9-31.1-13.3-37.6-.6-9,0-15.6,5.2-22.2s15-9.8,22.7-8.8a26.7,26.7,0,0,1,17.3,9.4c5.3,5.8,9.4,12.9,11.6,16.6" fill="#ffffff30"></path>
                            ...
                            <use width="31.4" height="33.93" transform="matrix(0.99, -0.03, 0.04, 1, 539.85, 203.52)" xlinkHref="#dc-siderequest-ticklingcat-paw-pads"></use>
                        </g>
                        <g className={styles.pawleftdown}>
                            <path d="M538.2,239.3c-3.2,1.6-33,10.8-37,28-.4,1.8-2.1,18.9,7,26,5.5,4.3,12.7,2.8,25,0,10.3-2.3,19-5.8,40-16,9.1-4.4,16.6-8.2,22-11" fill="#ffffff30"></path>
